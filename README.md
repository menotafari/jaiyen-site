...
KIT_ACTION (Kit form action URL) and STRIPE_LINK (Stripe Payment Link for the $49 reserve).
Until they are set, the form falls back to a mailto and the reserve link stays hidden.
